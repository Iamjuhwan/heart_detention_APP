...
def main():
  ...
  #      mean_std_values = pickle.load(f)
    newmodel = pickle.load(open(model_filename, 'rb'))
    ...
    if st.button('Predict'):
        ...
        user_input = (user_input - newmodel['mean']) / newmodel['std']
...
from sklearn.preprocessing import StandardScaler  # If you're using a scaler
...
#scaler = pickle.load(open('path_to_your_scaler.pkl', 'rb'))
